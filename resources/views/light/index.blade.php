@extends('layouts.app', ['pageSlug' => 'light'])
...
@section('content')
    <div class="row">
        ...
        <div class="col-lg-12">
            <div class="card card-chart">
                <div class="card-header">
                    <h5 class="card-title"><i class="fa fa-lightbulb light-color"></i> @lang('Today')</h5>
    ...
    <div class="row">
        <div class="col-lg-6 col-md-12">
            <div class="card ">
                <div class="card-header history_block">
                    <div class="">
                        <h4>@lang('History')</h4>
                    </div>
                    <div class=''>
                        <div class="input_group">
                            <input type="text" class="form-control datepicker" placeholder="@lang('Date')" value="12-02-2012">
...
@push('js')
    <script>
        ...
        var first_page_url = '{{url('/light/getTable?page=1') }}';
        ...
        $(document).ready(function() {
          ...
          demo.initChart(yValues, '#e5e806');

          demo.getTable(first_page_url);
